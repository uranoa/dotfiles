...
let g:pdv_cfg_Package = "als (assembly-line system)"
let g:pdv_cfg_SubPackage = "als."
let g:pdv_cfg_Version = "$Revision$"
let g:pdv_cfg_ModifiedBy = "$LastChangedBy$"
let g:pdv_cfg_LastModified = "$Date$"
let g:pdv_cfg_Author = "Atsushi Urano <uranoa@gmail.com>"
let g:pdv_cfg_Copyright = "Copyright (c) 2009-2010, Atsushi Urano"
...
func! PhpDocClass()
    ...
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "@filesource" . g:pdv_cfg_EOL
	...
	exe l:txtBOL . g:pdv_cfg_Commentn . "@modifiedby     " . g:pdv_cfg_ModifiedBy . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "@lastmodified   " . g:pdv_cfg_LastModified . g:pdv_cfg_EOL
